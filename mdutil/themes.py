...
DRACULA: dict[str, Any] = {
    ...
    "markdown": {
        ...
        "superscript": "#6272a4",
        "highlight": "#f1fa8c",
        "definition_term": "#8be9fd",
        "definition_definition": "#f8f8f2",
...
HIGH_CONTRAST: dict[str, Any] = {
    ...
    "markdown": {
        ...
        "superscript": "#aaaaaa",
        "highlight": "#ffff00",
        "definition_term": "#00ffff",
        "definition_definition": "#ffffff",
        "strikethrough": "#888888",
...
ONE_DARK: dict[str, Any] = {
    ...
    "markdown": {
        ...
        "superscript": "#5c6370",
        "highlight": "#e5c07b",
        "definition_term": "#61afef",
        "definition_definition": "#abb2bf",
