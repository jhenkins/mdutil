...
- [x] v3.0: Render document to PDF and/or HTML
  ...
  - [x] Phase 4: CLI & Configuration (multi-format `--export pdf,html`, `--output-dir`, config `[export]` section, theme passthrough)
...
|- [x] v3.1: Missing v3.0 export features
  - [x] Phase 1: Shared export syntax highlighting plumbing (KB-014a/014b/014c/014d)
    - [x] KB-014a: Trace terminal highlighting pipeline
    - [x] KB-014b: Design export theme mapping
    - [x] KB-014c: Build tokenizer helpers for exporters
...
|- [x] v5.0: Better Markdown rendering
  ...
  - [x] Phase 3a: Definition lists (KB-065, KB-066)
  - [x] Phase 3b: Image rendering (KB-067, KB-068 parser/renderer done; KB-069, KB-070 exporters pending)
